...
export const metadata: Metadata = {
  title: "Allo | Premium Smartphones & Mobile Phones",
  description: "Shop latest flagship and budget smartphones at Allo. Premium phones with expert service. Find your perfect phone today.",
  keywords: "smartphones, mobile phones, phone store, flagship phones, cell phones",
  openGraph: {
    title: "Allo | Premium Smartphones & Mobile Phones",
    description: "Discover cutting-edge smartphones with the latest technology. Shop Allo for quality phones and exceptional service.",
    siteName: "Allo",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766000811090-71erymlx.jpg",
        alt: "Allo premium smartphones"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Allo | Premium Smartphones",
    description: "Shop the latest flagship and budget smartphones with Allo",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1766000811090-71erymlx.jpg"]
  }
};
